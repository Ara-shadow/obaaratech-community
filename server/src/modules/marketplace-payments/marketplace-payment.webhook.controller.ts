...
export async function flutterwaveMarketplaceWebhookController(
    ...
    if (!signature) {
        ...
        request.log.warn(
            "Flutterwave webhook signature missing"
        );
    ...
    if (!reference) {
        ...
        request.log.warn(
            "Flutterwave webhook transaction reference missing"
        );
    ...
    const transaction =
        await prisma.marketplaceTransaction.findFirst({
    ...
    if (
        ...
        return reply
            ...
            .send({
                ...
                message:
                    "Marketplace transaction already processed"
