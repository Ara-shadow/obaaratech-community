...
// CREATE PAYMENT
// =====================================
export async function createPayment(userId, planId, amount, paymentMethod, reference, proofUrl) {
...
// =====================================
export async function updatePaymentReference(paymentId, reference) {
...
// APPROVE PAYMENT
// =====================================
export async function approvePayment(paymentId, adminNote) {
    return prisma.sellerPayment.update({
        where: {
            id: paymentId
        },
...
// REJECT PAYMENT
// =====================================
export async function rejectPayment(paymentId, adminNote) {
    return prisma.sellerPayment.update({
        where: {
            id: paymentId
        },
...
// ATOMIC TRANSACTION
// =====================================
export async function approvePaymentAndActivateSubscription(paymentId, adminNote) {
    return prisma.$transaction(async (tx) => {
        ...
        // =================================
        const existing = await tx.sellerSubscription.findUnique({
            where: {
        ...
        // APPROVE PAYMENT
        // =================================
        const approvedPayment = await tx.sellerPayment.update({
            where: {
                id: paymentId
            },
            data: {
