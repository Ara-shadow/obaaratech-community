...
// ===============================
export async function processListingImage(buffer) {
    ...
    if (!detectedType) {
        throw new Error("Unable to determine image file type");
    }
...
export async function uploadImage(buffer) {
    const processedBuffer = await processListingImage(buffer);
...
function getCloudinaryPublicId(url) {
    try {
        ...
        let path = parsed.pathname.substring(uploadIndex +
            "/upload/".length);
        path =
            path.replace(/^v\d+\//, "");
        ...
        throw new Error("Unable to determine Cloudinary image ID");
    }
}
// ===============================
// DELETE IMAGE SERVICE
// ===============================
export async function deleteListingImage(listingId, imageId, userId) {
