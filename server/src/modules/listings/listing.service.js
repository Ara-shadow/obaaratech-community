...
import { createListingWithFeatured, getListings, getListingById, getMyListings, updateListing as updateListingRepository, deleteListing, changeListingStatus, searchListings } from "./listing.repository.js";
...
export async function updateListingStatus(id, userId, status) {
    return changeListingStatus(id, status);
}
