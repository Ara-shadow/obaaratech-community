import type { SellerBusinessHour } from "@prisma/client";

// =====================================================
// TYPES
// =====================================================

export type SellerBusinessStatus = {
    isOpen: boolean;
    status: "OPEN" | "CLOSED";
    message: string;
...
export function calculateSellerBusinessStatus(
    hours: SellerBusinessHour[],
    date: Date = new Date()
