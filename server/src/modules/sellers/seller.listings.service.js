...
// =================================
export async function updateSellerListing(userId, listingId, data) {
...
// =================================
export async function deleteSellerListing(userId, listingId) {
    const listing = await prisma.listing.findUnique({
        where: {
            id: listingId
        }
...
// MARK LISTING SOLD
// =================================
export async function markListingSold(userId, listingId) {
    const listing = await prisma.listing.findUnique({
        where: {
            id: listingId
        }
